...
{
    public partial class Cotizacion_almacen : Form
    {
        ...
        public Cotizacion_almacen(Cotizacion frm, bool _funcion)
        {
            InitializeComponent();
            Coti = frm;
            funcion = _funcion;
        ...
        private void Cotizacion_almacen_Load(object sender, EventArgs e)
        {
            visualizarAlmacen();
        }
        ...
        void buscar()
        {
            ...
            for (int fila = 0; fila < aux.Rows.Count; fila++)
            {
                ...
                row["Metros"] = metros;
                row["Piezas"] = _almacen.barras(row["Codigo"].ToString(), metros);
            }
            tblAlmacen.DataSource = aux;
            tblAlmacen.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
        }
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            for (int i = (rows.Count - 1); i >= 0; i--)
            {
                ...
                Agregar_cotizacion pro = new Agregar_cotizacion(Coti, codigo, funcion);
        ...
        private void Cotizacion_almacen_Resize(object sender, EventArgs e)
        {
            Size size = this.Size;
